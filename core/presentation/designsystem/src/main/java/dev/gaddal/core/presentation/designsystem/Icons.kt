...
object AppIcons {
    ...
    val EyeOff: ImageVector
        @Composable
        get() = ImageVector.vectorResource(id = R.drawable.eye_off)
...
fun AppIconsPreview(modifier: Modifier = Modifier) {
    NoteMarkTheme {
        Surface(
            ...
            val icons = listOf(
                AppIcons.Copy to "Copy",
                AppIcons.Eye to "Eye",
                AppIcons.EyeOff to "Eye Off",
                AppIcons.Plus to "Plus",
            )

            LazyVerticalGrid(
                columns = GridCells.Fixed(4), // You can adjust the number of columns
                modifier = Modifier
                    .padding(14.dp)
                    .fillMaxSize(),
